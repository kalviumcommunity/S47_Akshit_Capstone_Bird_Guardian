...
const SignIn = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = `${import.meta.env.VITE_APP_URL}/auth/signin`;
      ...
      if (response.status === 200 || response.status === 201) {
        ...
        console.error("Error submitting form:", resData);
  ...
  return (
    <div className="h-screen flex items-center justify-center relative overflow-hidden bg-neutral-950 px-4">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 -right-40 w-96 h-96 bg-amber-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1.5s' }} />
      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-neutral-400">Sign in to continue to Bird Guardian</p>
        </div>
